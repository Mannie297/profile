...
import {loggo, menu, close} from '../assets';
      ...
      max-w-7xl mx-auto'>
        <Link 
          ...
          onClick={() => {
            ...
            <img src={loggo} alt='logo' className='w-9 h-9 object-contain'/>
        ...
        {/*To style application on smaller devices*/}
        ...
        items-center'>
          ...
          {/*code to show menu in the drop down*/}
